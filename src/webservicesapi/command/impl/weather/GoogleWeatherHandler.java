...
public class GoogleWeatherHandler extends DefaultHandler {
    ...
    private Logger logger = LoggerFactory.getLogger(GoogleWeatherHandler.class);
    ...
    private volatile boolean documentCompleted = false;
    ...
    public Object getEndDocumentLock() {
        return notify;
    }
