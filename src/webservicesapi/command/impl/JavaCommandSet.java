...
// java -Djcurses.protocol.filename=DEBUG.txt -cp "./out/production/webservicesapi/
// $CLASSPATH" webservicesapi.Main
    ...
    public Map<String, JavaConfiguration> parseApplications(AbstractFileConfiguration config) {
        ...
        // the code below parses the option files into JavaAppliction objects

        // java.jar.appname
        // java.lib.appname
        // java.main.appname
        // java.source.appname
        // java.options.appname
        ...
        while (i.hasNext()) {
            ...
            if (key.startsWith("java.")) {
                ...
                // parse out this java profile name
